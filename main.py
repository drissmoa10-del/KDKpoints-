...
def db_get_stats():
    ...
    conn.close()
    return total_users, phones_count, total_withdrawals, total_surveys
...
def hourly_status_cron():
    ...
    while True:
        try:
            total_users, phones_count, total_withdrawals, total_surveys = db_get_stats()
            msg = (
...
def main():
    ...
    # تسجيل الأوامر باش تخدم بشكل طبيعي بدون مشاكل
